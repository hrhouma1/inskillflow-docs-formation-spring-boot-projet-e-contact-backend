...
Cas A : pas authentifié → doit être refusé (401)
Cas B : authentifié mais mauvais rôle → refus (403)
Cas C : authentifié avec bon rôle → autorisé (200/201/204)
Cas D : route publique → accessible sans auth (200)
